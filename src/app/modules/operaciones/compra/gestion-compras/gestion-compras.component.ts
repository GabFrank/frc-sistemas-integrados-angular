  ...
  implements OnInit, OnDestroy, AfterViewInit
{
  ...
  private updatePedidoCabecera(): void {
    ...
    const pedidoInput = {
      ...
      usuarioId: this.currentPedido!.usuario?.id || this.mainService.usuarioActual?.id || 1, // Mantener el usuario original o usar el actual
  ...
  private savePedidoCabecera(): void {
    ...
    this.pedidoService
      .onSavePedidoFull(
        ...
        sucursalEntregaList,
        sucursalInfluenciaList,
        this.mainService.usuarioActual?.id || 1,
      )
      .subscribe({
        next: (result) => {
          this.currentPedido = result;
